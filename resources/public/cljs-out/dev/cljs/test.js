...
var G__22380 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__22380,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__22380;
}
}));
...
var len__4864__auto___22385 = arguments.length;
var i__4865__auto___22386 = (0);
while(true){
if((i__4865__auto___22386 < len__4864__auto___22385)){
args__4870__auto__.push((arguments[i__4865__auto___22386]));

var G__22387 = (i__4865__auto___22386 + (1));
i__4865__auto___22386 = G__22387;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq22382){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22383,G__22384,seq22382__$2);
}));
...
var file = cljs.core.get.call(null,map__22389__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__22389__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__22389__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__22388_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__22388_SHARP_));
...
var temp__5720__auto___22390 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___22390)){
var message_22391 = temp__5720__auto___22390;
cljs.core.println.call(null,message_22391);
} else {
}
...
var temp__5720__auto___22392 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___22392)){
var message_22393 = temp__5720__auto___22392;
cljs.core.println.call(null,message_22393);
} else {
}
...
var output_dir__$1 = (function (){var G__22394 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__22394,"/"].join('');
} else {
return G__22394;
}
})();
...
var G__22395 = exception.stack;
var G__22395__$1 = (((G__22395 == null))?null:clojure.string.split_lines.call(null,G__22395));
var G__22395__$2 = (((G__22395__$1 == null))?null:cljs.core.get.call(null,G__22395__$1,depth));
if((G__22395__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__22395__$2);
}
} else {
...
var vec__22396 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__22396,(0),null);
var column = cljs.core.nth.call(null,vec__22396,(1),null);
var vec__22399 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__22399,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__22399,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__22399,(2),null);
...
var m__$1 = (function (){var G__22402 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__22406 = (function (){var G__22405 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__22405);
} else {
return G__22405;
}
})();
...
return cljs.core.vary_meta.call(null,G__22407,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__22411 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__22411,(0),null);
var types = vec__22411;
...
return cljs.core.map.call(null,(function (p__22414){
var vec__22415 = p__22414;
var ns = cljs.core.nth.call(null,vec__22415,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__22415,(1),null);
return (function (){
...
var G__22418 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__22419 = cljs.core.seq.call(null,vars__$1);
var chunk__22420 = null;
var count__22421 = (0);
var i__22422 = (0);
while(true){
if((i__22422 < count__22421)){
var v = cljs.core._nth.call(null,chunk__22420,i__22422);
var temp__5720__auto___22424 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___22424)){
var t_22425 = temp__5720__auto___22424;
each_fixture_fn.call(null,((function (seq__22419,chunk__22420,count__22421,i__22422,t_22425,temp__5720__auto___22424,v,each_fixture_fn,G__22418,G__22418__$1,env,once_fixtures,each_fixtures,vec__22415,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_22425)));
});})(seq__22419,chunk__22420,count__22421,i__22422,t_22425,temp__5720__auto___22424,v,each_fixture_fn,G__22418,G__22418__$1,env,once_fixtures,each_fixtures,vec__22415,ns,vars__$1))
);
} else {
}


var G__22426 = seq__22419;
var G__22427 = chunk__22420;
var G__22428 = count__22421;
var G__22429 = (i__22422 + (1));
seq__22419 = G__22426;
chunk__22420 = G__22427;
count__22421 = G__22428;
i__22422 = G__22429;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__22419);
if(temp__5720__auto__){
var seq__22419__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__22419__$1)){
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__22419__$1);
var G__22430 = cljs.core.chunk_rest.call(null,seq__22419__$1);
var G__22431 = c__4679__auto__;
var G__22432 = cljs.core.count.call(null,c__4679__auto__);
var G__22433 = (0);
seq__22419 = G__22430;
chunk__22420 = G__22431;
count__22421 = G__22432;
i__22422 = G__22433;
continue;
} else {
var v = cljs.core.first.call(null,seq__22419__$1);
var temp__5720__auto___22434__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___22434__$1)){
var t_22435 = temp__5720__auto___22434__$1;
each_fixture_fn.call(null,((function (seq__22419,chunk__22420,count__22421,i__22422,t_22435,temp__5720__auto___22434__$1,v,seq__22419__$1,temp__5720__auto__,each_fixture_fn,G__22418,G__22418__$1,env,once_fixtures,each_fixtures,vec__22415,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_22435)));
});})(seq__22419,chunk__22420,count__22421,i__22422,t_22435,temp__5720__auto___22434__$1,v,seq__22419__$1,temp__5720__auto__,each_fixture_fn,G__22418,G__22418__$1,env,once_fixtures,each_fixtures,vec__22415,ns,vars__$1))
);
} else {
}


var G__22436 = cljs.core.next.call(null,seq__22419__$1);
var G__22437 = null;
var G__22438 = (0);
var G__22439 = (0);
seq__22419 = G__22436;
chunk__22420 = G__22437;
count__22421 = G__22438;
i__22422 = G__22439;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22418__$1)].join('')));
