...
var G__16965 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__16965,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__16965;
}
}));
...
var len__4864__auto___16970 = arguments.length;
var i__4865__auto___16971 = (0);
while(true){
if((i__4865__auto___16971 < len__4864__auto___16970)){
args__4870__auto__.push((arguments[i__4865__auto___16971]));

var G__16972 = (i__4865__auto___16971 + (1));
i__4865__auto___16971 = G__16972;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq16967){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16968,G__16969,seq16967__$2);
}));
...
var file = cljs.core.get.call(null,map__16974__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__16973_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__16973_SHARP_));
...
var temp__5720__auto___16975 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___16975)){
var message_16976 = temp__5720__auto___16975;
cljs.core.println.call(null,message_16976);
} else {
}
...
var temp__5720__auto___16977 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___16977)){
var message_16978 = temp__5720__auto___16977;
cljs.core.println.call(null,message_16978);
} else {
}
...
var output_dir__$1 = (function (){var G__16979 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__16979,"/"].join('');
} else {
return G__16979;
}
})();
...
var G__16980 = exception.stack;
var G__16980__$1 = (((G__16980 == null))?null:clojure.string.split_lines.call(null,G__16980));
var G__16980__$2 = (((G__16980__$1 == null))?null:cljs.core.get.call(null,G__16980__$1,depth));
if((G__16980__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__16980__$2);
}
} else {
...
var vec__16981 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__16981,(0),null);
var column = cljs.core.nth.call(null,vec__16981,(1),null);
var vec__16984 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__16984,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__16984,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__16984,(2),null);
...
var m__$1 = (function (){var G__16987 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__16991 = (function (){var G__16990 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__16990);
} else {
return G__16990;
}
})();
...
return cljs.core.vary_meta.call(null,G__16992,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__16996 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__16996,(0),null);
var types = vec__16996;
...
return cljs.core.map.call(null,(function (p__16999){
var vec__17000 = p__16999;
var ns = cljs.core.nth.call(null,vec__17000,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__17000,(1),null);
return (function (){
...
var G__17003 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__17004 = cljs.core.seq.call(null,vars__$1);
var chunk__17005 = null;
var count__17006 = (0);
var i__17007 = (0);
while(true){
if((i__17007 < count__17006)){
var v = cljs.core._nth.call(null,chunk__17005,i__17007);
var temp__5720__auto___17009 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___17009)){
var t_17010 = temp__5720__auto___17009;
each_fixture_fn.call(null,((function (seq__17004,chunk__17005,count__17006,i__17007,t_17010,temp__5720__auto___17009,v,each_fixture_fn,G__17003,G__17003__$1,env,once_fixtures,each_fixtures,vec__17000,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17010)));
});})(seq__17004,chunk__17005,count__17006,i__17007,t_17010,temp__5720__auto___17009,v,each_fixture_fn,G__17003,G__17003__$1,env,once_fixtures,each_fixtures,vec__17000,ns,vars__$1))
);
} else {
}


var G__17011 = seq__17004;
var G__17012 = chunk__17005;
var G__17013 = count__17006;
var G__17014 = (i__17007 + (1));
seq__17004 = G__17011;
chunk__17005 = G__17012;
count__17006 = G__17013;
i__17007 = G__17014;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__17004);
if(temp__5720__auto__){
var seq__17004__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__17004__$1)){
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__17004__$1);
var G__17015 = cljs.core.chunk_rest.call(null,seq__17004__$1);
var G__17016 = c__4679__auto__;
var G__17017 = cljs.core.count.call(null,c__4679__auto__);
var G__17018 = (0);
seq__17004 = G__17015;
chunk__17005 = G__17016;
count__17006 = G__17017;
i__17007 = G__17018;
continue;
} else {
var v = cljs.core.first.call(null,seq__17004__$1);
var temp__5720__auto___17019__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___17019__$1)){
var t_17020 = temp__5720__auto___17019__$1;
each_fixture_fn.call(null,((function (seq__17004,chunk__17005,count__17006,i__17007,t_17020,temp__5720__auto___17019__$1,v,seq__17004__$1,temp__5720__auto__,each_fixture_fn,G__17003,G__17003__$1,env,once_fixtures,each_fixtures,vec__17000,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17020)));
});})(seq__17004,chunk__17005,count__17006,i__17007,t_17020,temp__5720__auto___17019__$1,v,seq__17004__$1,temp__5720__auto__,each_fixture_fn,G__17003,G__17003__$1,env,once_fixtures,each_fixtures,vec__17000,ns,vars__$1))
);
} else {
}


var G__17021 = cljs.core.next.call(null,seq__17004__$1);
var G__17022 = null;
var G__17023 = (0);
var G__17024 = (0);
seq__17004 = G__17021;
chunk__17005 = G__17022;
count__17006 = G__17023;
i__17007 = G__17024;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17003__$1)].join('')));
