...
return [(function (){var pred__15381 = cljs.core.instance_QMARK_;
var expr__15382 = reactive_val;
if(cljs.core.truth_(pred__15381.call(null,reagent.ratom.RAtom,expr__15382))){
return "ra";
} else {
if(cljs.core.truth_(pred__15381.call(null,reagent.ratom.RCursor,expr__15382))){
return "rc";
} else {
if(cljs.core.truth_(pred__15381.call(null,reagent.ratom.Reaction,expr__15382))){
return "rx";
} else {
if(cljs.core.truth_(pred__15381.call(null,reagent.ratom.Track,expr__15382))){
return "tr";
} else {
return "other";
}
