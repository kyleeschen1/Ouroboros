...
var ob$analyzer$IAnalyze$_analyze$dyn_137550 = (function (form,env){
...
return ob$analyzer$IAnalyze$_analyze$dyn_137550.call(null,form,env);
}
});
...
var map__137551 = cljs.core.meta.call(null,form);
var map__137551__$1 = cljs.core.__destructure_map.call(null,map__137551);
var id = cljs.core.get.call(null,map__137551__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var child_ids = cljs.core.get.call(null,map__137551__$1,new cljs.core.Keyword(null,"child-ids","child-ids",-604525861));
var parent_id = cljs.core.get.call(null,map__137551__$1,new cljs.core.Keyword(null,"parent-id","parent-id",-1400729131));
...
(ob.utils.Constant.prototype.ob$analyzer$IAnalyze$_analyze$arity$2 = (function (p__137552,env){
var map__137553 = p__137552;
var map__137553__$1 = cljs.core.__destructure_map.call(null,map__137553);
var form = map__137553__$1;
var value = cljs.core.get.call(null,map__137553__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__137554 = this;
var map__137554__$1 = cljs.core.__destructure_map.call(null,map__137554);
var form__$1 = map__137554__$1;
var value__$1 = cljs.core.get.call(null,map__137554__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
var form__$1 = this;
var vec__137555 = form__$1;
var k = cljs.core.nth.call(null,vec__137555,(0),null);
var v = cljs.core.nth.call(null,vec__137555,(1),null);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"ob.analyzer","analyze-sexpr"),(function (p__137558,_){
var vec__137559 = p__137558;
var seq__137560 = cljs.core.seq.call(null,vec__137559);
var first__137561 = cljs.core.first.call(null,seq__137560);
var seq__137560__$1 = cljs.core.next.call(null,seq__137560);
var op = first__137561;
var ___$1 = seq__137560__$1;
return cljs.core.keyword.call(null,op);
}),new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__4751__auto__,method_table__4747__auto__,prefer_table__4748__auto__,method_cache__4749__auto__,cached_hierarchy__4750__auto__));
})();
}
cljs.core._add_method.call(null,ob.analyzer.analyze_sexpr,new cljs.core.Keyword(null,"default","default",-1987822328),(function (p__137562,env){
var vec__137563 = p__137562;
var seq__137564 = cljs.core.seq.call(null,vec__137563);
var first__137565 = cljs.core.first.call(null,seq__137564);
var seq__137564__$1 = cljs.core.next.call(null,seq__137564);
var op = first__137565;
var args = seq__137564__$1;
var form = vec__137563;
...
cljs.core._add_method.call(null,ob.analyzer.analyze_sexpr,new cljs.core.Keyword(null,"if","if",-458814265),(function (p__137566,env){
var vec__137567 = p__137566;
var op = cljs.core.nth.call(null,vec__137567,(0),null);
var pred = cljs.core.nth.call(null,vec__137567,(1),null);
var then = cljs.core.nth.call(null,vec__137567,(2),null);
var else$ = cljs.core.nth.call(null,vec__137567,(3),null);
var form = vec__137567;
...
cljs.core._add_method.call(null,ob.analyzer.analyze_sexpr,new cljs.core.Keyword(null,"def","def",-1043430536),(function (p__137570,env){
var vec__137571 = p__137570;
var op = cljs.core.nth.call(null,vec__137571,(0),null);
var sym = cljs.core.nth.call(null,vec__137571,(1),null);
var val = cljs.core.nth.call(null,vec__137571,(2),null);
var form = vec__137571;
return new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"op","op",-1882987955),new cljs.core.Keyword(null,"def","def",-1043430536),new cljs.core.Keyword(null,"form","form",-1624062471),form,new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operator","operator",-1860875338),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"val","val",128701612)], null),new cljs.core.Keyword(null,"operator","operator",-1860875338),ob.analyzer.analyze_sf.call(null,op,env),new cljs.core.Keyword(null,"sym","sym",-1444860305),ob.analyzer.analyze.call(null,sym,env),new cljs.core.Keyword(null,"val","val",128701612),ob.analyzer.analyze.call(null,val,env)], null);
}));
cljs.core._add_method.call(null,ob.analyzer.analyze_sexpr,new cljs.core.Keyword(null,"do","do",46310725),(function (p__137574,env){
var vec__137575 = p__137574;
var seq__137576 = cljs.core.seq.call(null,vec__137575);
var first__137577 = cljs.core.first.call(null,seq__137576);
var seq__137576__$1 = cljs.core.next.call(null,seq__137576);
var op = first__137577;
var args = seq__137576__$1;
var form = vec__137575;
...
cljs.core._add_method.call(null,ob.analyzer.analyze_sexpr,new cljs.core.Keyword(null,"quote","quote",-262615245),(function (p__137578,env){
var vec__137579 = p__137578;
var op = cljs.core.nth.call(null,vec__137579,(0),null);
var arg = cljs.core.nth.call(null,vec__137579,(1),null);
var form = vec__137579;
...
cljs.core._add_method.call(null,ob.analyzer.analyze_sexpr,new cljs.core.Keyword(null,"fn","fn",-1175266204),(function (p__137582,env){
var vec__137583 = p__137582;
var op = cljs.core.nth.call(null,vec__137583,(0),null);
var params = cljs.core.nth.call(null,vec__137583,(1),null);
var body = cljs.core.nth.call(null,vec__137583,(2),null);
var form = vec__137583;
...
cljs.core._add_method.call(null,ob.analyzer.analyze_sexpr,new cljs.core.Keyword(null,"let","let",-1282412701),(function (p__137586,env){
var vec__137587 = p__137586;
var op = cljs.core.nth.call(null,vec__137587,(0),null);
var bv = cljs.core.nth.call(null,vec__137587,(1),null);
var body = cljs.core.nth.call(null,vec__137587,(2),null);
var form = vec__137587;
...
cljs.core._add_method.call(null,ob.analyzer.analyze_sexpr,new cljs.core.Keyword(null,"loop","loop",-395552849),(function (p__137590,env){
var vec__137591 = p__137590;
var op = cljs.core.nth.call(null,vec__137591,(0),null);
var bv = cljs.core.nth.call(null,vec__137591,(1),null);
var body = cljs.core.nth.call(null,vec__137591,(2),null);
var form = vec__137591;
var bv__$1 = ob.analyzer.analyze_bv.call(null,bv,env);
var body__$1 = ob.analyzer.analyze.call(null,body,env);
...
cljs.core._add_method.call(null,ob.analyzer.analyze_sexpr,new cljs.core.Keyword(null,"tag","tag",-1290361223),(function (p__137594,env){
var vec__137595 = p__137594;
var seq__137596 = cljs.core.seq.call(null,vec__137595);
var first__137597 = cljs.core.first.call(null,seq__137596);
var seq__137596__$1 = cljs.core.next.call(null,seq__137596);
var op = first__137597;
var first__137597__$1 = cljs.core.first.call(null,seq__137596__$1);
var seq__137596__$2 = cljs.core.next.call(null,seq__137596__$1);
var tag = first__137597__$1;
var args = seq__137596__$2;
var form = vec__137595;
...
ob.analyzer.analyze_macro = (function ob$analyzer$analyze_macro(p__137598,env){
var map__137599 = p__137598;
var map__137599__$1 = cljs.core.__destructure_map.call(null,map__137599);
var macro = cljs.core.get.call(null,map__137599__$1,new cljs.core.Keyword(null,"macro","macro",-867863404));
var _AMPERSAND_ = cljs.core.get.call(null,map__137599__$1,new cljs.core.Keyword(null,"&","&",509580121));
var args = cljs.core.get.call(null,map__137599__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var as = cljs.core.get.call(null,map__137599__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var form = cljs.core.get.call(null,map__137599__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
...
ob.analyzer.analyze_sf = (function ob$analyzer$analyze_sf(operator,p__137600){
var map__137601 = p__137600;
var map__137601__$1 = cljs.core.__destructure_map.call(null,map__137601);
var depth = cljs.core.get.call(null,map__137601__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
