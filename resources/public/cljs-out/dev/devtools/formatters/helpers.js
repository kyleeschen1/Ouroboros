...
var G__18722 = devtools.prefs.pref.call(null,v);
v = G__18722;
continue;
} else {
return v;
...
}catch (e18723){var _e__18463__auto__ = e18723;
return false;
}})();
...
}catch (e18725){var _e__18463__auto__ = e18725;
return false;
}})();
...
}catch (e18727){var _e__18463__auto__ = e18727;
return false;
}}
}
});
...
var vec__18729 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__18729,(0),null);
var name = cljs.core.nth.call(null,vec__18729,(1),null);
...
return cljs.core.some.call(null,(function (p1__18732_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__18732_SHARP_);
}),template);
});
