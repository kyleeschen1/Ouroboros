...
}catch (e19230){var _e__18463__auto__ = e19230;
return false;
...
}catch (e19232){var _e__18463__auto__ = e19232;
return false;
...
}catch (e19234){var _e__18463__auto__ = e19234;
return false;
...
}catch (e19236){var _e__18463__auto__ = e19236;
return false;
...
}catch (e19238){var _e__18463__auto__ = e19238;
return false;
}})())){
...
}catch (e19240){var _e__18463__auto__ = e19240;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__19242 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__19243 = (function (){var or__4253__auto__ = config;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__19243);

try{return raw_fn.call(null,value);
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__19242);
}});
});
...
while (G__19246__i < G__19246__a.length) {G__19246__a[G__19246__i] = arguments[G__19246__i + 0]; ++G__19246__i;}
  args = new cljs.core.IndexedSeq(G__19246__a,0,null);
} 
