...
var o18620 = temp__5718__auto__;
var temp__5718__auto____$1 = (o18620["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o18621 = temp__5718__auto____$1;
return (o18621["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__18456__auto__ = f;
return (o__18456__auto__["toString"]).call(o__18456__auto__);
} else {
return "";
}
}catch (e18622){var _ = e18622;
return "";
}});
...
try{var o__18456__auto___18624 = t;
(o__18456__auto___18624["cljs$lang$ctorPrWriter"]).call(o__18456__auto___18624,t,writer);
}catch (e18623){var __18625 = e18623;
}
...
var char_code = (function (){var o__18456__auto__ = (new String(char$));
return (o__18456__auto__["charCodeAt"]).call(o__18456__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__18456__auto__ = String;
return (o__18456__auto__["fromCharCode"]).call(o__18456__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18626 = num_code;
switch (G__18626) {
case (1):
return (185);
...
var o__18456__auto__ = String;
return (o__18456__auto__["fromCharCode"]).call(o__18456__auto__,superscript_code);
});
/**
...
}catch (e18628){var _e__18463__auto__ = e18628;
return false;
}})())){
...
var vec__18629 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__18629,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__18634){
var vec__18635 = p__18634;
var ns_detector = cljs.core.nth.call(null,vec__18635,(0),null);
...
var G__18641 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__18642 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__18641;
remaining_tokens = G__18642;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq18632){
var G__18633 = cljs.core.first.call(null,seq18632);
var seq18632__$1 = cljs.core.next.call(null,seq18632);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18633,seq18632__$1);
}));
...
var vec__18646 = cljs.core.split_with.call(null,(function (p1__18645_SHARP_){
return cljs.core.not_EQ_.call(null,p1__18645_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__18646,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__18646,(1),null);
...
var vec__18652 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__18652,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__18652,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__18655 = cljs.core.rest.call(null,remaining_tokens);
var G__18656 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__18655;
name_tokens = G__18656;
continue;
} else {
...
var vec__18659 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__18659,(0),null);
var arity = cljs.core.nth.call(null,vec__18659,(1),null);
var vec__18662 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__18662,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__18662,(1),null);
var vec__18665 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__18665,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__18665,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__18665,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__18665,(3),null);
...
var vec__18671 = result;
var munged_ns = cljs.core.nth.call(null,vec__18671,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__18671,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__18671,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__18671,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__18671,(4),null);
var arity = cljs.core.nth.call(null,vec__18671,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__18675 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__18675,(0),null);
var args = cljs.core.nth.call(null,vec__18675,(1),null);
var vec__18678 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__18678,(0),null);
var name = cljs.core.nth.call(null,vec__18678,(1),null);
...
var G__18681 = (arity + (1));
var G__18682 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18683){
var vec__18684 = p__18683;
var arity = cljs.core.nth.call(null,vec__18684,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__18684,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__18687_SHARP_){
return cljs.core.get.call(null,arities,p1__18687_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__18688_SHARP_){
return cljs.core.drop.call(null,(2),p1__18688_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18691){
var vec__18692 = p__18691;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__18692,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18689){
var G__18690 = cljs.core.first.call(null,seq18689);
var seq18689__$1 = cljs.core.next.call(null,seq18689);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18690,seq18689__$1);
}));
...
var map__18700 = options;
var map__18700__$1 = cljs.core.__destructure_map.call(null,map__18700);
var include_ns_QMARK_ = cljs.core.get.call(null,map__18700__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__18700__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__18700__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__18700__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__18701 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__18701,(0),null);
var fn_name = cljs.core.nth.call(null,vec__18701,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__18701,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__18701,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__18701,(4),null);
var arity = cljs.core.nth.call(null,vec__18701,(5),null);
...
var o__18456__auto__ = f;
return (o__18456__auto__["getBasis"]).call(o__18456__auto__);
});
/**
...
}catch (e18704){var _e__18463__auto__ = e18704;
...
var G__18705 = (obj[cljs.core.first.call(null,path)]);
var G__18706 = cljs.core.rest.call(null,path);
obj = G__18705;
path = G__18706;
continue;
} else {
...
var _STAR_ = (function (accum,p__18707){
var vec__18708 = p__18707;
var bit = cljs.core.nth.call(null,vec__18708,(0),null);
var protocol = cljs.core.nth.call(null,vec__18708,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__18711){
var vec__18712 = p__18711;
var ns = cljs.core.nth.call(null,vec__18712,(0),null);
var name = cljs.core.nth.call(null,vec__18712,(1),null);
var selector = cljs.core.nth.call(null,vec__18712,(2),null);
...
var post_process = (function (p__18716){
var vec__18717 = p__18716;
var munged_name = cljs.core.nth.call(null,vec__18717,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__18717,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__18715_SHARP_){
return (obj[cljs.core.first.call(null,p1__18715_SHARP_)]);
}),sorted_matches);
