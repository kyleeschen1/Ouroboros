...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_22911);
...
var len__4864__auto___22915 = arguments.length;
var i__4865__auto___22916 = (0);
while(true){
if((i__4865__auto___22916 < len__4864__auto___22915)){
args__4870__auto__.push((arguments[i__4865__auto___22916]));

var G__22917 = (i__4865__auto___22916 + (1));
i__4865__auto___22916 = G__22917;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq22912){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22913,G__22914,seq22912__$2);
}));
...
var vec__22918 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__22918,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__22918,(1),null);
var G__22921 = cljs.core.PersistentArrayMap.EMPTY;
var G__22921__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__22921,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22921);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__22921__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__22921__$1;
}
} else {
...
return (function() { 
var G__22925__delegate = function (klass,contents){
var vec__22922 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__22922,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__22922,(1),null);
...
var G__22925 = function (klass,var_args){
var contents = null;
...
while (G__22926__i < G__22926__a.length) {G__22926__a[G__22926__i] = arguments[G__22926__i + 1]; ++G__22926__i;}
  contents = new cljs.core.IndexedSeq(G__22926__a,0,null);
} 
return G__22925__delegate.call(this,klass,contents);};
G__22925.cljs$lang$maxFixedArity = 1;
G__22925.cljs$lang$applyTo = (function (arglist__22927){
var klass = cljs.core.first(arglist__22927);
var contents = cljs.core.rest(arglist__22927);
return G__22925__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__22931){
var map__22932 = p__22931;
var map__22932__$1 = cljs.core.__destructure_map.call(null,map__22932);
var ns = cljs.core.get.call(null,map__22932__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__22933){
var map__22934 = p__22933;
var map__22934__$1 = cljs.core.__destructure_map.call(null,map__22934);
var actual = cljs.core.get.call(null,map__22934__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__22934__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__22935){
var map__22936 = p__22935;
var map__22936__$1 = cljs.core.__destructure_map.call(null,map__22936);
var expected = cljs.core.get.call(null,map__22936__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__22936__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__22937_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__22937_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__22939 = cljs_test_display.core.current_var_info.call(null);
var map__22939__$1 = cljs.core.__destructure_map.call(null,map__22939);
var info = map__22939__$1;
var name = cljs.core.get.call(null,map__22939__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__22939__$1,new cljs.core.Keyword(null,"line","line",212345235));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__22938_SHARP_){
return cljs.core.cons.call(null,node,p1__22938_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__22940){
var map__22941 = p__22940;
var map__22941__$1 = cljs.core.__destructure_map.call(null,map__22941);
var m = map__22941__$1;
var fail = cljs.core.get.call(null,map__22941__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__22941__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__22941__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__22941__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___22942 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___22942)){
var message_22943 = temp__5720__auto___22942;
cljs.core.println.call(null,message_22943);
} else {
}
...
var temp__5720__auto___22944 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___22944)){
var message_22945 = temp__5720__auto___22944;
cljs.core.println.call(null,message_22945);
} else {
}
