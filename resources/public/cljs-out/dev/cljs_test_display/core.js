...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_17748);
...
var len__4864__auto___17752 = arguments.length;
var i__4865__auto___17753 = (0);
while(true){
if((i__4865__auto___17753 < len__4864__auto___17752)){
args__4870__auto__.push((arguments[i__4865__auto___17753]));

var G__17754 = (i__4865__auto___17753 + (1));
i__4865__auto___17753 = G__17754;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq17749){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17750,G__17751,seq17749__$2);
}));
...
var vec__17755 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__17755,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__17755,(1),null);
var G__17758 = cljs.core.PersistentArrayMap.EMPTY;
var G__17758__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__17758,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17758);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__17758__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__17758__$1;
}
} else {
...
return (function() { 
var G__17762__delegate = function (klass,contents){
var vec__17759 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__17759,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__17759,(1),null);
...
var G__17762 = function (klass,var_args){
var contents = null;
...
while (G__17763__i < G__17763__a.length) {G__17763__a[G__17763__i] = arguments[G__17763__i + 1]; ++G__17763__i;}
  contents = new cljs.core.IndexedSeq(G__17763__a,0,null);
} 
return G__17762__delegate.call(this,klass,contents);};
G__17762.cljs$lang$maxFixedArity = 1;
G__17762.cljs$lang$applyTo = (function (arglist__17764){
var klass = cljs.core.first(arglist__17764);
var contents = cljs.core.rest(arglist__17764);
return G__17762__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__17768){
var map__17769 = p__17768;
var map__17769__$1 = cljs.core.__destructure_map.call(null,map__17769);
var ns = cljs.core.get.call(null,map__17769__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__17769__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__17770){
var map__17771 = p__17770;
var map__17771__$1 = cljs.core.__destructure_map.call(null,map__17771);
var actual = cljs.core.get.call(null,map__17771__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__17771__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__17772){
var map__17773 = p__17772;
var map__17773__$1 = cljs.core.__destructure_map.call(null,map__17773);
var expected = cljs.core.get.call(null,map__17773__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__17773__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__17774_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__17774_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__17776 = cljs_test_display.core.current_var_info.call(null);
var map__17776__$1 = cljs.core.__destructure_map.call(null,map__17776);
var info = map__17776__$1;
var name = cljs.core.get.call(null,map__17776__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__17776__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__17776__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__17775_SHARP_){
return cljs.core.cons.call(null,node,p1__17775_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__17777){
var map__17778 = p__17777;
var map__17778__$1 = cljs.core.__destructure_map.call(null,map__17778);
var m = map__17778__$1;
var fail = cljs.core.get.call(null,map__17778__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__17778__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__17778__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__17778__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___17779 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___17779)){
var message_17780 = temp__5720__auto___17779;
cljs.core.println.call(null,message_17780);
} else {
}
...
var temp__5720__auto___17781 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___17781)){
var message_17782 = temp__5720__auto___17781;
cljs.core.println.call(null,message_17782);
} else {
}
